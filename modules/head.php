<head>
    ...
    <meta
      name="description"
      content="White Dental page"
    />
    <meta
      name="keywords"
      content="medical, clinic, dental, dental clinic, dental practice, dentist, dentistry, doctor, health, hospital,"/>

    <!-- Page Title -->
    <title>White Dental</title>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-VG82XPT0XJ"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'G-VG82XPT0XJ');
    </script>
  </head>